...
Fichier : index_https.js
Commande : node index_https.js
Description : Script à executer pour lancer l'API en HTTPS, celui-ci initialise l'application en respectant les configurations stipulées
...
// Création du serveur
const serveur = https.createServer(credits, app);
